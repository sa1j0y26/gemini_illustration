...
- プレイヤー数は1〜4人
- 全員に同一のお題を提示する
- AIにはお題そのものは渡さず、候補選択肢(`choices`)のみを文脈として渡す
...
1. MVP土台 (完了)
   ...
   - モックAI評価
2. AI実接続
   - Google LiveAPIで `evaluateWithGoogleLive` 実装
   - 選択肢プロンプト設計・判定精度改善
3. リアルタイム強化
...
- Google LiveAPI / NanoBanana はスタブ接続点のみ
